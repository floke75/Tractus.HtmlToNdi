...
| `--enable-compositor-capture` | Off | Disables Chromium's auto begin-frame scheduling and lets the native compositor helper stream frames directly, bypassing the paced invalidation path.【F:Launcher/LaunchParameters.cs†L151-L357】【F:Chromium/CefWrapper.cs†L40-L144】【F:Native/CompositorCaptureBridge.cs†L1-L235】 |
